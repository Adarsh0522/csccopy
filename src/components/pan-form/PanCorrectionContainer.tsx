  ...
  return (
    <div
      ...
      className={cn(
        ...
        isOpen ? "border-emerald-200 ring-4 ring-emerald-500/10 shadow-md" : "border-slate-200 shadow-sm",
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          isOpen ? "bg-emerald-50 text-emerald-700" : "bg-white hover:bg-slate-50"
        )}
      >
            ...
            {showSuccessModal && (
              <div className="fixed inset-0 z-[100] flex items-center justify-center px-4 py-6">
                ...
                >
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-2">Correction Form Generated</h2>
          ...
          <div className="flex-1 bg-slate-100 rounded-xl overflow-hidden border border-slate-200 relative shadow-inner flex flex-col items-center justify-center">
            {previewUrl ? (
              ...
              <div className="w-full h-full flex flex-col items-center justify-center p-6 text-center">
                ...
                <p className="text-[10px] text-slate-400 px-2">Select update fields and enter Old PAN to generate preview.</p>
              </div>
            )}
