  ...
  return (
    <div className="flex flex-col h-full space-y-6 max-w-4xl mx-auto w-full">
      <div className="text-center space-y-2 mb-4">
        <h2 className="text-2xl font-bold text-gray-900">PDF to JPG</h2>
        <p className="text-gray-500">Extract every page of a PDF document into high-quality JPG images.</p>
      </div>
      ...
      {!file ? (
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-3xl p-10 flex flex-col items-center space-y-8 flex-1 justify-center">
          <div className="flex flex-col items-center text-center space-y-3">
            ...
            <div>
              <h3 className="font-bold text-gray-900 text-lg truncate max-w-xs">{file.name}</h3>
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="text-gray-500 hover:text-gray-700 font-medium px-4 py-2 underline"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-3 rounded-full font-semibold transition-all shadow-md active:scale-95 disabled:opacity-50"
            >
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 bg-gray-50 p-6 rounded-3xl border border-gray-200">
            {extractedImages.map((_, i) => (
              <div key={i} className="flex flex-col items-center space-y-3">
                <div className="w-full aspect-[1/1.4] bg-white border border-gray-200 rounded-xl shadow-sm flex items-center justify-center p-2 relative group">
                  <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity rounded-xl flex items-center justify-center">
                    <button className="bg-white text-gray-900 rounded-full p-3 shadow-lg hover:scale-110 transition-transform">
          ...
          <div className="flex justify-center pt-4">
            <button className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-10 py-3 rounded-full font-semibold transition-all shadow-md active:scale-95">
              <Download className="w-5 h-5" />
              Download All as ZIP
            </button>
          </div>
