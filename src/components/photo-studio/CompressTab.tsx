  ...
  return (
    <div className="flex flex-col h-full space-y-6 max-w-4xl mx-auto w-full">
      <div className="text-center space-y-2 mb-4">
        <h2 className="text-2xl font-bold text-slate-900">Compress Image</h2>
        <p className="text-slate-500">Reduce file size while preserving quality.</p>
      </div>
      ...
      {!file ? (
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-3xl p-8 flex flex-col items-center space-y-8">
          <div className="w-full flex justify-between items-center bg-white p-4 rounded-xl border border-slate-200">
            <div className="flex flex-col">
              <span className="font-semibold text-slate-700 truncate max-w-[200px] sm:max-w-xs">{file.name}</span>
          ...
          {!result ? (
            <div className="w-full max-w-md space-y-6">
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <label className="font-semibold text-slate-700">Compression Quality</label>
                  <span className="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-sm font-bold">{quality}%</span>
                </div>
                <input
                  type="range"
                  min="1"
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-xl font-semibold transition-all shadow-md active:scale-95 disabled:opacity-50"
              >
            ...
            <div className="w-full max-w-md flex flex-col items-center space-y-6">
              ...
              <button className="w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-xl font-semibold transition-all shadow-md active:scale-95">
