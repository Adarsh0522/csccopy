...
export default function AddBalancePage() {
  ...
  return (
    <div className="min-h-[calc(100vh-73px)] bg-slate-100 p-6 lg:p-8 flex items-center justify-center">
      ...
      <div className="w-full max-w-lg space-y-6">
        <div className="text-center space-y-2 mb-8">
          ...
          <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">Add Balance</h1>
          <p className="text-slate-500 font-medium">Recharge your wallet to use premium CSCCopy services.</p>
        </div>

        <Card className="border-slate-200 shadow-lg bg-white ring-1 ring-slate-900/5">
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-9 h-14 text-lg font-bold border-slate-200 bg-slate-50 focus-visible:ring-blue-500"
