  ...
  return (
    <div className="w-full h-full animate-in fade-in duration-500">
      ...
      <div className="no-print space-y-8">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">PVC Card Print</h1>
          <p className="text-gray-500 mt-2">Select your document type, upload, adjust, and print perfectly aligned cards.</p>
        </div>

        {/* --- Card Type Selector --- */}
        <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-4">
          <label className="text-sm font-semibold text-gray-700">Select Document Type</label>
          <div className="relative">
            <select
              ...
              className="w-full appearance-none bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block p-3.5 cursor-pointer font-medium outline-none transition-all hover:bg-gray-100"
            >
              {CARD_TYPES.map(type => (
        ...
        {/* --- PDF Mode --- */}
        {!isManual && !file && (
          <div className="border-2 border-dashed border-emerald-200 rounded-3xl p-16 flex flex-col items-center justify-center bg-emerald-50/50 cursor-pointer hover:bg-emerald-50 transition-colors group relative overflow-hidden">
            <div className="absolute inset-0 opacity-20 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-emerald-400 via-transparent to-transparent group-hover:scale-150 transition-transform duration-700" />
            <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center mb-6 shadow-sm border border-emerald-100 relative z-10 group-hover:-translate-y-2 transition-transform duration-300">
              <Upload className="w-10 h-10 text-emerald-600" />
            </div>
            <h3 className="text-xl font-bold mb-2 text-gray-900 relative z-10">Upload {docType} PDF</h3>
            <p className="text-sm text-gray-500 mb-6 relative z-10 font-medium">Click to browse or drag and drop</p>
            <Input 
              type="file" 
        ...
        {isManual && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-3">
              <h3 className="font-semibold text-gray-700">Front Side Image</h3>
              <div className="relative border-2 border-dashed border-gray-300 rounded-2xl flex flex-col items-center justify-center bg-white min-h-[250px] overflow-hidden group hover:border-emerald-400 transition-colors">
                {frontImage ? (
                  ...
                  <div className="text-center flex flex-col items-center pointer-events-none p-6">
                    ...
                    <p className="text-sm font-semibold text-gray-700">Upload Front</p>
                    <p className="text-xs text-gray-500 mt-1">Image format only</p>
                  </div>
                )}
                <Input 
                  type="file" 
            ...
            {/* Back Upload */}
            <div className="space-y-3">
              <h3 className="font-semibold text-gray-700">Back Side Image</h3>
              <div className="relative border-2 border-dashed border-gray-300 rounded-2xl flex flex-col items-center justify-center bg-white min-h-[250px] overflow-hidden group hover:border-emerald-400 transition-colors">
                {backImage ? (
                  ...
                  <div className="text-center flex flex-col items-center pointer-events-none p-6">
                    ...
                    <p className="text-sm font-semibold text-gray-700">Upload Back</p>
                    <p className="text-xs text-gray-500 mt-1">Image format only</p>
                  </div>
                )}
                <Input 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
                <h3 className="font-semibold mb-6 text-lg text-gray-900">Photo Adjustments</h3>
                <div className="space-y-6">
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      <Label className="text-gray-700 font-medium">Brightness</Label>
                      <span className="text-sm font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-md">{brightness}%</span>
                    </div>
                    <Slider 
                      value={[brightness]} 
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-md">{contrast}%</span>
                    </div>
                    <Slider 
                      value={[contrast]} 
                      min={0} max={200} step={1}
              ...
              <Button onClick={handlePrint} size="lg" className="w-full text-lg h-14 rounded-xl bg-emerald-600 hover:bg-emerald-700 shadow-md transition-all active:scale-95">
            ...
            <div className="bg-emerald-50 border border-emerald-200 p-8 rounded-2xl flex flex-col items-center justify-center text-center">
              ...
              <h4 className="font-bold text-gray-900 text-lg mb-2">Ready to Print</h4>
      ...
      <div className="print-container mt-12 no-print-margin">
        <h2 className="no-print text-xl font-bold mb-4 text-center text-gray-400">--- A4 Print Layout Preview ---</h2>
          ...
          <div className="card-grid">
            ...
            {Array.from({ length: 5 }).map((_, i) => (
              <div key={i} className="card-row">
                {/* Front Card */}
                <div className="pvc-card relative bg-gray-100 overflow-hidden">
                  {!isManual && (
                  ...
                  {!isManual && extractedPhoto && i === 0 && (
                    <img 
                      src={extractedPhoto} 
                      alt="Extracted User"
                      className="absolute top-4 left-4 w-[25mm] h-[30mm] object-cover border border-gray-300 shadow-sm z-10"
      ...
      <Dialog open={isPasswordModalOpen} onOpenChange={setIsPasswordModalOpen}>
        <DialogContent className="sm:max-w-md rounded-2xl">
          ...
          <DialogFooter>
            ...
            }} className="rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white">Unlock & Process</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
